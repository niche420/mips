...
impl Gte {
    ...
    fn cmd_rtps(&mut self, config: CommandConfig) -> ClockCycle {
        // Transform vector 0
    ...
    /// Normal clipping
    fn cmd_nclip(&mut self) -> ClockCycle {
    ...
    /// Outer Product
    fn cmd_op(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    /// Depth Queue Single
    fn cmd_dpcs(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    fn cmd_dcpl(&mut self, config: CommandConfig) -> ClockCycle {
        let fc = ControlVector::FarColor.index();
    ...
    /// Depth Queue Triple
    fn cmd_dpct(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    fn cmd_intpl(&mut self, config: CommandConfig) -> ClockCycle {
        let fc = ControlVector::FarColor.index();
    ...
    fn cmd_mvmva(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    fn cmd_ncds(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    /// Color Depth Cue
    fn cmd_cdp(&mut self, config: CommandConfig) -> ClockCycle {
        self.v[3][0] = self.ir[1];
        self.v[3][1] = self.ir[2];
        self.v[3][2] = self.ir[3];
    ...
    fn cmd_ncdt(&mut self, config: CommandConfig) -> ClockCycle {
        self.do_ncd(config, 0);
    ...
    fn cmd_nccs(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    /// Color Color
    fn cmd_cc(&mut self, config: CommandConfig) -> ClockCycle {
        self.v[3][0] = self.ir[1];
        self.v[3][1] = self.ir[2];
        self.v[3][2] = self.ir[3];
    ...
    /// Normal Color Single
    fn cmd_ncs(&mut self, config: CommandConfig) -> ClockCycle {
        self.do_nc(config, 0);
        13
    }

    /// Normal Color Triple
    fn cmd_nct(&mut self, config: CommandConfig) -> ClockCycle {
        self.do_nc(config, 0);
        self.do_nc(config, 1);
        self.do_nc(config, 2);
    ...
    /// Square vector
    fn cmd_sqr(&mut self, config: CommandConfig) -> ClockCycle {
        for i in 1..4 {
    ...
    fn cmd_avsz3(&mut self) -> ClockCycle {
    ...
    fn cmd_avsz4(&mut self) -> ClockCycle {
    ...
    fn cmd_rtpt(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    fn cmd_gpf(&mut self, config: CommandConfig) -> ClockCycle {
    ...
    fn cmd_gpl(&mut self, config: CommandConfig) -> ClockCycle {
        let ir0 = self.ir[0] as i32;
    ...
    fn cmd_ncct(&mut self, config: CommandConfig) -> ClockCycle {
        // Transform the three vectors at once
        self.do_ncc(config, 0);
